...
This page is the root for repository documentation.
...
- Keep ADR files under 120 lines.
- Link every new document from this index or another reachable page.
- Place generated or archived documentation under ignored folders only when review does not depend on it.
